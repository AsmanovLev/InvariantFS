...
| WP14b | exe-as-container: ELF/PE section carving, embedded media (JPEG/PNG magic-scan) -> JXL, text regions -> PPMd batch, verbatim recipe + bit-exact guard; container-member batching (lift the '!'-sibling exclusion, WP10 #12.7) | design+code | L |
