...
# after `make`. Uses /tmp/invfs-e2e like the other soak scripts; image paths
...
gcc -std=gnu11 -O2 -I$REPO/src -I$REPO/src/core -I$REPO/src/codecs -I$REPO/src/recipes -I$REPO/src/vendor7z -o "$WORK/ff_harness" \
